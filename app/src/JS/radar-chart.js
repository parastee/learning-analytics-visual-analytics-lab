var RadarChart = {
      ...
      function radar(selection) {
        selection.each(function(data) {
          ...
          .on('mouseover', function (dd){
            ...
            setTooltip(tooltip, cfg.tooltipFormatClass(dd.name));
          })
    ...
    draw: function(id, d, options) {
      ...
      var svgMain=d3.select(id)
      .append("svg");
      svgMain.attr("width", cfg.w+300)
      .attr("height", cfg.h)
      .datum(d)
      .call(chart);
      var LegendOptions =d.map(a=>a.name);
      ////////////////////////////////////////////
/////////// Initiate legend ////////////////
////////////////////////////////////////////

var svg = svgMain.append('svg')
